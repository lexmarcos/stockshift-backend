...
class BatchSoftDeleteTest extends BaseIntegrationTest {
        ...
        void setUpTestData() {
                ...
                testTenant = TestDataFactory.createTenant(tenantRepository, "Soft Delete Test Tenant",
                                "44444444000104");
        ...
        void shouldNotReturnDeletedBatchesInFindAll() throws Exception {
                ...
                Batch batch1 = TestDataFactory.createBatch(batchRepository, testTenant.getId(), testProduct,
                                testWarehouse, 10);
                Batch batch2 = TestDataFactory.createBatch(batchRepository, testTenant.getId(), testProduct,
                                testWarehouse, 20);
