...
public class WarehouseController {
    ...
    @PostMapping
    @PreAuthorize("@permissionGuard.hasAny('warehouses:create')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("@permissionGuard.hasAny('warehouses:update')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("@permissionGuard.hasAny('warehouses:delete')")
